...
//        Assert.assertEquals(response.getStatusCode() + "", expected_status_code);
    ...
    @Test(dataProvider = "Ownership_details_by_Forest_ID")
    @Story("This story belongs to the OwnershipDetailsByForestID")
    public void OwnershipDetailsCluster(String ownership_id,String page_number, String expected_status_code,String expected_Status_body){
...
//        Assert.assertEquals(response.getStatusCode() + "", expected_status_code);
    ...
    public void SouthernHemisphereSeaIceIndex(String number_of_year, String expected_status_code, String Description) {
